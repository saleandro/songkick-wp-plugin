...
function songkick_admin_settings() {
	...
	if (current_user_can('manage_options') && isset($_POST['songkick_submit']) && $_POST['songkick_submit']) {
		...
		$limit_gigs = (int)$_POST['songkick_number_of_gigs'];
		if ($limit_gigs > 50) $limit_gigs = 50;
		$options['number_of_gigs'] = $limit_gigs;
		...
		$limit_gigs = (int)$_POST['songkick_shortcode_number_of_gigs'];
		if ($limit_gigs > 50) $limit_gigs = 50;
		$options['shortcode_number_of_gigs'] = $limit_gigs;		
	...
	$number_of_gigs   = htmlspecialchars($options['number_of_gigs']);
	...
	$shortcode_number_of_gigs   = htmlspecialchars($options['shortcode_number_of_gigs']);

	echo '<div class="wrap" id="songkick_concerts_and_festivals_settings">
		     <div id="icon-options-general" class="icon32"></div>
   		     <h2>Songkick Concerts and Festivals Settings</h2>';

	echo '<p class="description">Add [songkick_concerts_and_festivals] or [songkick_gigography] anywhere in a content to get your list of events.</p>';
	...
	echo '</td></tr>';
	echo '<tr><td colspan="2">For users:&nbsp;&nbsp;<code>[songkick_gigography songkick_id=your_username &nbsp;songkick_id_type=user]</code>';
	echo ' <br>For artists: <code>[songkick_gigography songkick_id=your_artist_id songkick_id_type=artist]</code>';
	echo '</td></tr>';
	...
	echo '</td></tr>';
	echo '<tr><th><label for="songkick_shortcode_number_of_gigs">Number of past events to show</label></th>';
	echo '<td><input id="songkick_shortcode_number_of_gigs" name="songkick_shortcode_number_of_gigs" type="text" value="'.$shortcode_number_of_gigs.'" /> ';
	echo '<span class="description"> Max. 50</span>';
	echo '</td></tr>';
	...
	echo '<tr><th><label for="songkick_number_of_gigs">Number of past events to show</label></th>';
	echo '<td><input id="songkick_number_of_gigs" name="songkick_number_of_gigs" type="text" value="'.$number_of_gigs.'" /> ';
	echo '<span class="description"> Max. 50</span>';
	echo '</td></tr>';
